...
@section('content')
    <div
        ...
        <div class="container-fluid">
            ...
            <h2 class="dashboard-title">Admin Car</h2>
                                ...
                                <form action="{{ route('car.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="penalty" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>No. Plat</label>
                                                <input type="text" name="v_regist_number" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col text-right">
                                            <button type="submit" class="btn btn-info px-5" onclick="return alert('Mobil berhasil ditambahkan')">
                                                Simpan
                                            </button>
                                        </div>
                                    </div>
